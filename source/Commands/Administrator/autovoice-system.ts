import { CategoryChannel, ChannelType, Guild, PermissionFlagsBits, SlashCommandBuilder } from "discord.js";
    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand.setName("delete")
                .setDescription("Delete the autovoice system that has that interface.")
